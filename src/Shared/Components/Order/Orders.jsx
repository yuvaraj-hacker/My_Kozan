                ...
                <div className='w-full flex flex-col gap-5'>
                    ...
                    <div className={`border ${step === 1 ? 'block' : 'hidden'}`}>
                        ...
                        <div className='p-5 max-w-[25rem]'>
                            ...
                            <div className='mt-5'>
                                <button onClick={() => setStep(2)} className='p-3 bg-[#E38734] lg:text-xl text-lg font-bold text-white rounded-lg'>
                                    Continue
                                </button>
                            </div>
                        </div>
                    ...
                    <div className={`border ${step === 2 ? 'block' : 'hidden'}`}>
                        ...
                        <div className='p-5 max-w-[25rem]'>
                            ...
                            <div className='mt-5'>
                                <button onClick={() => setStep(3)} className='p-3 bg-[#E38734] lg:text-xl text-lg font-bold text-white rounded-lg'>
                                    Continue
                                </button>
                            </div>
                        </div>
                    ...
                    <div className={`border ${step === 3 ? 'block' : 'hidden'}`}>
                        ...
                        <div className='p-5 max-w-[25rem]'>
                            ...
                            <div className='mt-5'>
                                <button onClick={() => setStep(4)} className='p-3 bg-[#E38734] lg:text-xl text-lg font-bold text-white rounded-lg'>
                                    Continue
                                </button>
                            </div>
                        </div>
